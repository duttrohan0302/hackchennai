...
const HomePage =  ({isAuthenticated})  => {
    ...
    return(
        <div className="m-2">
            {
                dataSet &&
                <UncontrolledAlert>
                    Data Registered! Head Over to Dashboard or districts to view the data
                </UncontrolledAlert>
            }
          <Form onSubmit={formData}>
            ...
            <FormGroup>
                <Label for="seroIndex">Sero Index</Label>
                <Input
                type="text"
                name="seroIndex"
                placeholder="Enter Sero Index of your district"
                required
                />
            </FormGroup>
        ...
        <input {...getInputProps()} />
        <p>Drag 'n' drop the district data file here in csv format</p>
      </div>
      <aside>
        <ul>{files}</ul>
        </aside>
